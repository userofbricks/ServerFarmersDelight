...
public abstract class ConfigBuilder {
    ...
    public static ConfigBuilder create(String modId, ConfigType type) {
        return create(Identifier.of(modId, type.getDefaultName()), type);
    }
    ...
    private static class ResourceLocationConfigValue implements Supplier<Identifier> {

        private final Supplier<String> inner;
        private Identifier cache;
        private String oldString;

        public ResourceLocationConfigValue(ConfigBuilder builder, String path, Identifier defaultValue) {
        ...
        public Identifier get() {
            ...
            oldString = s;
            if (cache == null) cache = Identifier.of(s);
            return cache;
        }
    }
